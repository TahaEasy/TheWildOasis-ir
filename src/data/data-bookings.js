...
export const bookings = [
  // CABIN 001
  {
    ...
    observations:
      "من حساسیت به گلوتن دارم و می خواهم یک صبحانه بدون گلوتن درخواست کنم.",
    isPaid: false,
    numGuests: 1,
  },
  {
  ...
  // CABIN 006
  {
    ...
    hasBreakfast: false,
    observations:
      "ما اواخر، حدود نیمه شب بررسی خواهیم کرد. امیدوارم مشکلی نداشته باشه :)",
    isPaid: true,
    numGuests: 6,
  },
  {
  ...
  // CABIN 008
  {
    ...
    breakfastType: "english",
    observations:
      "همسرم به گلوتن آلرژی دارد، بنابراین در صورت امکان می خواهم یک صبحانه بدون گلوتن درخواست کنم",
    isPaid: true,
    numGuests: 9,
  },
  {
    ...
    breakfastType: "continental",
    observations:
      "من سالگرد خود را جشن می‌گیرم، آیا می‌توانید امکانات یا تزئینات خاصی را ترتیب دهید؟",
    isPaid: true,
    numGuests: 10,
  },
  {
